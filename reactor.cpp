...
void myfnn(int &nx, double x[], double fnn[]){
	...
	for ( int kk = 0; kk < nx; kk++ ){fnn[kk] = x2[kk];}
...
void mymix(int &nx, double x1[], double x2[], double alpha[], int iusr[], double rusr[] ){
	...
	T1[0] = x1[0]; for ( int ii = 1; ii < nx; ii++ ){Y1[ii-1]=x1[ii];}
	T2[0] = x2[0]; for ( int ii = 1; ii < nx; ii++ ){Y2[ii-1]=x2[ii];}
	...
	x1[0] = T1[0]; for ( int ii = 1; ii < nx; ii++ ){x1[ii]=Y1[ii-1];}
	x2[0] = T2[0]; for ( int ii = 1; ii < nx; ii++ ){x2[ii]=Y2[ii-1];}
